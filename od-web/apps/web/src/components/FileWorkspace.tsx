...
// Excalidraw is a heavy dependency; defer its bundle until a sketch is
// actually opened (or the idle prewarm fires) so it stays out of the initial
// app chunk. Both components are only rendered here.
      ...
      <div className="ws-body">
        ...
        {initialMaterializationPending ? (
          ...
          <div className="viewer-empty">
            <p>Terminal se ejecuta en opencode.</p>
          </div>
        ) : activeLiveArtifact ? (
          <LiveArtifactViewer
            projectId={projectId}
