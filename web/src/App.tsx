    ...
    <>
      {c.isDesktop ? (
        <DesktopLayoutView
          ...
          showTerminal={c.showTerminal}
          setShowTerminal={c.setShowTerminal}
          ...
          handleOpenDesign={c.handleOpenDesign}
          ...
          terminalDocked={c.terminalDocked}
          setTerminalDocked={c.setTerminalDocked}
          terminalHeight={c.terminalHeight}
          setTerminalHeight={c.setTerminalHeight}
          shellLines={c.shellLines}
          shellRunning={c.shellRunning}
          terminalShell={c.terminalShell}
          setTerminalShell={c.setTerminalShell}
          shellClear={c.shellClear}
          shellHistory={c.shellHistory}
