...
export default {
  ...
  'error.title': 'Errore',
  'error.close': 'Chiudi',
  'error.transport': 'Impossibile contattare il server. Verifica che Tailscale sia connesso su entrambi i dispositivi, che host e porta nelle Impostazioni siano corretti e che OpenHer sia ancora in esecuzione.',
  ...
  'composer.inputLabel': 'Messaggio per OpenHer',
  ...
  'menu.detailDescription': 'Chatta con OpenHer',
  ...
  'settings.connectedSaved': 'Connesso a OpenHer {version}. Configurazione salvata.',
  'settings.draftHint': 'Le modifiche vengono salvate automaticamente. Test controlla i campi qui sotto senza cambiare pagina.',
  'settings.testedNotSaved': 'Connessione OK: OpenHer {version}. Non è stato ancora salvato nulla.',
  ...
  'settings.defaultModelSearch': 'Cerca modello...',
  'settings.defaultModelNoResults': 'Nessun modello corrispondente',
  'settings.defaultModelHidden': '(nascosto)',
  ...
  'desktop.dataToggle': 'Dati',
  'desktop.dataHide': 'Nascondi dati',
  'desktop.dataShow': 'Mostra dati',
  'desktop.settings': 'Impostazioni',
  'session.remoteDesktop': 'Desktop remoto',
  'settings.desktopTitle': 'Desktop remoto',
  'settings.desktopHint': 'OpenHer Desktop Agent sul PC (desktop-agent, porta 5901). Stessa auth del server.',
  ...
  'settings.desktopOk': 'Connesso a {os} (v{v})',
  'settings.desktopFail': 'Connessione desktop fallita: {err}',
  ...
  'settings.questionError': 'Invio non riuscito. Riprova.',
  'update.available': 'Nuova versione {version} disponibile',
  'update.downloading': 'Download in corso…',
  'update.installing': 'Apertura installazione…',
...
'settings.featureFlagsDesc': 'Attiva o disattiva funzionalità aggiuntive',
  ...
  'connection.connecting': 'Connessione a OpenHer...',
  ...
  'connection.offline': 'OpenHer non è raggiungibile',
  'settings.connectionFailed': 'Connessione fallita: {message}',
  'settings.connectedTo': 'Connesso a OpenHer v{version}',
  ...
  'sessions.projectDirectoryInvalid': '{directory} non è una cartella progetto OpenHer. Scegli una cartella progetto/worktree oppure usa il default del server.',
...
'sessions.selectOne': 'Seleziona una sessione per iniziare',
  'sessions.loadingTitle': 'Connessione a OpenHer',
  'sessions.loadingHint': 'Carico le sessioni. Su mobile o dopo il risveglio del server può volerci qualche secondo.',
  'sessions.offlineHint': 'OpenHer non è ancora raggiungibile. Controlla Impostazioni o riprova con Aggiorna.',
...
'detail.thinking': 'Pensando…',
  ...
  'toolpart.background': 'In background',
  'toolpart.backgroundRunning': 'In background',
  'toolpart.backgroundHint': 'Esegue in background: continua a lavorare mentre fai altro',
  ...
  'session.promptHistory': 'Cronologia prompt',
  'session.promptHistoryEmpty': 'Nessun prompt ancora',
  'session.promptHistorySearch': 'Filtra prompt...',
  'session.promptHistoryDockLeft': 'Aggancia a sinistra',
  'session.promptHistoryDockRight': 'Aggancia a destra',
  'session.promptHistoryFloat': 'Pannello mobile',
  'session.archived': 'Archiviate',
  'session.themeCreator': 'Creatore temi',
  'session.compact': 'Compatta',
  'session.exportMd': 'Esporta .md',
  'session.exportMdPath': 'Percorso file',
  'session.exportMdSave': 'Salva',
  'session.files': 'File',
  ...
  'notification.completionTitle': 'OpenHer Completato',
  ...
  'mcpBrowser.noMatch': 'Nessun risultato',
  'mcp.title': 'MCP',
  'mcp.servers': 'Server MCP',
  'mcp.resources': 'Risorse',
  'mcp.status.connected': 'Connesso',
  'mcp.status.pending': 'Connessione…',
  'mcp.status.disabled': 'Disattivato',
  'mcp.status.failed': 'Errore',
  'mcp.status.needs_auth': 'Richiede autenticazione',
  'mcp.connect': 'Attiva',
  'mcp.disconnect': 'Disattiva',
  'mcp.working': 'Applicazione…',
  'mcp.refresh': 'Aggiorna',
  'mcp.empty': 'Nessun server MCP configurato',
  'mcp.v2Only': 'La gestione dei server MCP richiede API v2 (OpenHer v2)',
  'mcp.loadError': 'Impossibile caricare i server MCP',
  'mcp.actionError': 'Impossibile cambiare stato',
...
'fileEditor.loading': 'Caricamento file...',
  ...
  'extras.shutdownHostDesc': 'Invia un comando di spegnimento al computer che esegue il server OpenHer',
  'extras.shutdownConfirmTitle': 'Spegnere il computer host?',
  'extras.shutdownConfirmBody': 'Il computer che esegue il server OpenHer verrà spento. Questa azione non può essere annullata.',
...
'extras.restartHostDesc': 'Riavvia il computer che esegue il server OpenHer',
'extras.restartConfirmTitle': 'Riavviare il computer host?',
'extras.restartConfirmBody': 'Il computer che esegue il server OpenHer si riavvierà tra 10 secondi. Questa azione non può essere annullata.',
