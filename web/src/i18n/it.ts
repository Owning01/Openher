...
export default {
  ...
  'error.title': 'Errore',
  'error.close': 'Chiudi',
  'error.transport': 'Impossibile contattare il server. Verifica che Tailscale sia connesso su entrambi i dispositivi, che host e porta nelle Impostazioni siano corretti e che opencode sia ancora in esecuzione.',
