...
'extras.restartFailed': 'Error al enviar el comando de reinicio: {error}',
  ...
  'debate.title': 'Debate',
  'debate.openRoom': 'Abrir sala de debate',
  'debate.chip': 'Debate · {turns} turnos · consenso {pct}%',
  'debate.close': 'Cerrar',
  ...
  'debate.noDebate': 'Esta sesión todavía no tiene debate. Pedile al agente que inicie uno.',
  'debate.empty': 'Todavía no hay mensajes en este debate.',
  'debate.typing': 'debatiendo…',
  'debate.consensusLabel': 'Consenso',
  ...
  'debate.elapsed': '{time}',
  'debate.you': 'tú',
  'debate.consensusReady': 'CONSENSO',
  'debate.dissenting': 'DISIENTE',
  'debate.confidence': '{pct}% conf.',
  'debate.repliesTo': 'responde a {role}',
  'debate.actaTitle': 'Acta — árbitro',
  'debate.consensusYes': 'con consenso',
  'debate.consensusNo': 'sin consenso',
  'debate.actaConfidence': 'confianza {pct}%',
  'debate.minorities': 'Minorías',
