...
export default {
  ...
  'error.title': 'Error',
  'error.close': 'Cerrar',
  'error.transport': 'No se pudo contactar al servidor. Revisá que Tailscale esté conectado en ambos equipos, que el host y el puerto en Ajustes sean correctos y que OpenHer siga corriendo.',
  ...
  'settings.sb_studio': 'Estudio',
  'studio.title': 'Estudio',
  'studio.emptyTitle': 'Empezá un proyecto',
  'studio.emptyHint': 'Generá una base nueva o abrí algo que ya exista. Después seleccionás elementos y los editás con el agente.',
  'studio.newWithOpenDesign': 'Generar con Open Design',
  'studio.newWithOpenDesignDesc': 'Escribís el brief en OpenDesign y él genera el artefacto. Al terminar, se abre acá para editar el código real.',
  'studio.newWithOpenDesignHint': 'Diseñá en OpenDesign y después editá el código en el Estudio',
  'studio.openFolder': 'Abrir proyecto existente',
  'studio.openFolderDesc': 'Elegís una carpeta y el Estudio levanta su dev server con hot-reload para inspeccionar y editar.',
  'studio.back': 'Volver',
  'studio.refresh': 'Actualizar',
  'studio.detected': 'Detectados en Open Design',
  'studio.noProjects': 'No se detectaron proyectos. Generá uno en Open Design.',
  'studio.noDirectory': 'Sin working directory',
  'studio.openInStudio': 'Abrir en el Estudio',
  'studio.project': 'Proyecto',
  'studio.closeProject': 'Cerrar proyecto',
  'studio.devRunning': 'dev server · {url}',
  'studio.staticFallback': 'preview estático (sin dev server)',
  'studio.staticMode': 'preview estático',
  'studio.startDev': 'Iniciar dev server',
  'studio.starting': 'Levantando…',
  'studio.stopDev': 'Parar dev server',
  'studio.changeFolder': 'Cambiar carpeta',
  'studio.zones': 'Zonas marcadas',
  'studio.noZones': 'Todavía no hay zonas. Activá la selección y clic en un elemento del canvas.',
  'studio.removeZone': 'Quitar zona',
  'studio.openSource': 'Abrir fuente',
  'studio.zoneNotePlaceholder': '¿Qué querés cambiar acá?',
  'studio.entryPoint': 'Punto de entrada',
  'studio.agent': 'Agente',
  'studio.zonesCount': '{count} zonas · scopeado',
  'studio.creatingSession': 'Preparando la sesión del agente del proyecto…',
  'studio.sessionFailed': 'No se pudo crear la sesión del agente del proyecto. Puede que la carpeta no sea un proyecto de OpenHer.',
  'studio.retry': 'Reintentar',
  'studio.selectElement': 'Seleccionar elemento (clic)',
  'studio.selectArea': 'Marcar área (arrastrar)',
  'studio.reload': 'Recargar',
  'studio.inspecting': 'Seleccionando',
  ...
  'settings.connectedSaved': 'Conectado a OpenHer {version}. Configuración guardada.',
  'settings.draftHint': 'Los cambios se guardan automáticamente. La prueba verifica los campos sin cambiar de página.',
  'settings.testedNotSaved': 'Conexión OK: OpenHer {version}. Aún no se guardó nada.',
    ...
    'settings.pairTitle': 'OpenHer v2 Pair (BETA)',
    ...
    'settings.goTitle': 'Uso de OpenHer Go',
    'settings.goHint': 'Consultá tu cuota de OpenHer Go (rolling, semanal, mensual) vía la API pública.',
  ...
  'settings.defaultModelSearch': 'Buscar modelo...',
  'settings.defaultModelNoResults': 'Sin modelos coincidentes',
  'settings.defaultModelHidden': '(oculto)',
  ...
  'voice.noSpeech': 'No te escuché, probá de nuevo',
  'voice.busy': 'El dictado estaba ocupado, probá de nuevo',
  'voice.error': 'No se pudo usar el micrófono',
  'voice.privacy': 'Activa el reconocimiento de voz en línea en Ajustes > Privacidad y seguridad > Voz',
  ...
  'desktop.dataToggle': 'Datos',
  'desktop.dataHide': 'Ocultar datos',
  'desktop.dataShow': 'Mostrar datos',
  'desktop.settings': 'Configuración',
  'desktop.openDirError': 'No se pudo abrir la sesión en OpenHer',
  'session.remoteDesktop': 'Escritorio remoto',
  'settings.desktopTitle': 'Escritorio remoto',
  'settings.desktopHint': 'OpenHer Desktop Agent en la PC (desktop-agent, puerto 5901). Misma auth que el server.',
  ...
  'go.rolling': 'Últimas 5 horas',
  'go.weekly': 'Semanal',
  'go.monthly': 'Mensual',
  'go.resets': 'se libera',
  'go.models': '{count} modelos ofrecidos',
  'go.modelLimit': 'tope ${limit} · ${input}/${output} por 1M',
  'go.modelNew': 'modelo nuevo, sin ficha aún',
  'go.sourceCustom': 'Mostrando el uso de la key configurada en esta PC.',
  'go.sourceAuth': 'Mostrando el uso de la key del /connect (TUI).',
  'go.changeKey': 'Usar otra key',
  'go.useTuiKey': 'Volver a la de la TUI',
  'go.keyPlaceholder': 'Pega la API key de Go',
  'go.keyDesc': 'Se guarda solo en esta PC. Todos los que se conecten ven el uso de esa key.',
  'go.save': 'Guardar',
  'go.openUsage': 'Ver uso de OpenCode Go',
  'go.close': 'Cerrar',
  ...
  'settings.questionSkipped': 'Omitida',
  'settings.questionError': 'No se pudo enviar. Reintentá.',
  'update.available': 'Nueva versión {version} disponible',
  'update.downloading': 'Descargando…',
  'update.installing': 'Abriendo instalador…',
  'update.restarting': 'Reiniciando OpenHer…',
  'update.install': 'Actualizar',
  'update.error': 'No se pudo actualizar la app',
...
'settings.featureFlagsDesc': 'Activa o desactiva funciones adicionales',
  ...
  'detail.queuedSubtitle': 'Se envía cuando el agente termine de trabajar',
  ...
  'connection.connecting': 'Conectando a OpenHer...',
  ...
  'connection.offline': 'OpenHer no está accesible',
  'settings.connectionFailed': 'Conexión fallida: {message}',
  'settings.connectedTo': 'Conectado a OpenHer v{version}',
  ...
  'sessions.projectDirectoryInvalid': '{directory} no es una carpeta de proyecto OpenHer. Elige una carpeta de proyecto/worktree, o usa el valor por defecto del servidor.',
  ...
  'chat.activeSubagents': 'Subagentes activos ({count})',
  'chat.activeSubagentsHint': 'Ver los chats activos de subagentes de esta sesión',
  'chat.moveToBackground': 'Pasar a background',
  'chat.toolsMenu': 'tools',
  'chat.viewTag': 'vista',
  'chat.fromAgent': 'de {name}',
  'chat.moveToBackgroundHint': 'Pasa este chat a segundo plano: los subagentes que corren siguen trabajando',
...
'sessions.selectOne': 'Seleccioná una sesión para empezar',
  'sessions.loadingTitle': 'Conectando a OpenHer',
  'sessions.loadingHint': 'Cargando sesiones. Puede tomar unos segundos en móvil o después de que el servidor se active.',
  'sessions.offlineHint': 'OpenHer aún no está accesible. Revisa Configuración o pulsa Actualizar.',
  ...
  'shell.sendToSession': 'Enviar a sesión',
  'shell.promptToSend': 'Prompt a enviar',
  'shell.pickSession': 'Elegí la sesión',
  'shell.searchSessions': 'Buscar sesiones...',
  'shell.send': 'Enviar',
  'shell.sentTo': 'Enviado a {name}',
  'shell.sendFailed': 'No se pudo enviar',
  'shell.noSessionsFound': 'Sin sesiones',
  'shell.needsConfig': 'Configurá el servidor primero',
  'shell.moreSessions': '+{n} más — filtrá para ver',
  ...
  'shell.opencode2Server': 'Servidor OpenHer :4098',
  'shell.opencode2Start': 'Levantar servidor',
  'shell.opencode2Starting': 'Levantando…',
  'shell.opencode2Active': 'Servidor activo :4098',
  'shell.opencode2Fail': 'No respondió, reintentá',
  'shell.opencode2Stop': 'Apagar',
  'shell.opencode2Stopping': 'Apagando…',
  'shell.opencode2Restart': 'Reiniciar',
  'shell.opencode2Restarting': 'Reiniciando…',
  'shell.opencode2StopHint': 'Apagar o reiniciar detiene el servidor :4098; las sesiones abiertas quedan sin streaming hasta que vuelva. Con el arranque automático activo se levanta solo al iniciar sesión.',
  'shell.opencode2StopFail': 'No se pudo apagar, reintentá',
  'shell.apply': 'Aplicar',
...
'detail.thinking': 'Pensando…',
  ...
  'diff.annotateLine': 'Comentar esta línea',
  'diff.annotateHint': 'Clic en una línea para comentarla y mandarla al prompt',
  'diff.notePlaceholder': 'Qué habría que cambiar…',
  'diff.addNote': 'Agregar',
  'diff.removeNote': 'Quitar comentario',
  'diff.sendNotes': 'Enviar {count} al prompt',
  'settings.sectionAutomations': 'Automatizaciones',
  'settings.automationsDesc': 'Prompts recurrentes sobre una sesión, o comandos de shell en un terminal esperando a que quede quieto.',
  'settings.automationAdd': 'Agregar',
  'settings.automationName': 'Nombre',
  'settings.automationPrompt': 'Prompt',
  'settings.automationCommand': 'Comando',
  'settings.automationKindPrompt': 'Prompt',
  'settings.automationKindShell': 'Terminal',
  'settings.automationTarget': 'Destino (id de sesión o tab de terminal)',
  'settings.automationEmpty': 'Sin automatizaciones.',
  'settings.automationEnabled': 'activa',
  'settings.automationLastRun': 'Última corrida',
  'settings.automationNever': 'nunca',
  'settings.automationRunNow': 'Correr ahora',
  'settings.automationRemove': 'Borrar',
  'settings.automationStatusOk': 'ok',
  'settings.automationStatusError': 'error',
  'settings.automationStatusRunning': 'corriendo',
  'settings.automationEveryMin': 'cada {m} min',
  'settings.automationEveryH': 'cada {h} h',
  'settings.sectionRuns': 'Runs (fan-out)',
  'settings.runsDesc': 'Manda el mismo prompt a N agentes, cada uno en su worktree de git, y después mergea o descarta con un gate humano.',
  'settings.runsEmpty': 'Sin runs todavía.',
  'settings.runGateOpen': 'gate abierto',
  'settings.runGateClosed': 'gate cerrado',
  'settings.runCloseGate': 'Cerrar gate',
  'settings.runOpenGate': 'Abrir gate',
  'settings.runDispatch': 'Despachar',
  'settings.runMerge': 'Mergear',
  'settings.runDiscard': 'Descartar',
  'settings.runRemove': 'Borrar run',
  'settings.runNew': 'Nuevo run',
  'settings.runNewDesc': 'El repo tiene que ser el clon local; cada tarea crea <repo>.worktrees/<nombre> en la rama openher/<nombre>.',
  'settings.runName': 'Nombre del run',
  'settings.runRepo': 'Ruta del repo',
  'settings.runAgents': 'agentes',
  'settings.runPrompt': 'Prompt para todos los agentes',
  'settings.runCreate': 'Crear',
  'settings.runFailed': 'fallaron',
  'settings.runRemoveWt': '¿Borrar este run? Se eliminan de disco sus {count} worktree(s) (el trabajo ya fue mergiado o descartado).',
  'settings.runRemoveUnmerged': 'Queda trabajo sin mergear en {count} tarea(s): el run se quita del panel y sus worktrees quedan en disco en <repo>.worktrees (la rama openher/* conserva el trabajo).',
  'settings.runRemoveWtFail': 'No se pudieron borrar {count} worktree(s); quedan en <repo>.worktrees.',
  ...
  'toolpart.background': 'En segundo plano',
  'toolpart.backgroundRunning': 'En segundo plano',
  'toolpart.backgroundHint': 'Corre en segundo plano: sigue trabajando mientras hacés otra cosa',
  ...
  'help.server.content': '<b>Iniciar el Servidor OpenHer</b>|'
    + 'Inicia OpenHer con autenticación Basic Auth:|'
  ...
  'help.troubleshooting.content': '<b>Diagnóstico de Conexión</b>|'
    + '1. Verificar Servidor: Comprueba que OpenHer escuche en el puerto 4096|'
  ...
  'help.commands.content': 'Los comandos locales son manejados por la app. Los comandos del servidor se cargan desde OpenHer.',
  ...
  'session.opencodeHub': 'OpenCode Config',
  'session.terminal': 'Terminal',
  'session.notes': 'Bloc de notas',
  'notes.title': 'Bloc de notas',
  'notes.placeholder': 'Anotá ideas rápidas… se guarda solo en este chat',
  'notes.insert': 'Insertar en el composer',
  'notes.copy': 'Copiar notas',
  'notes.clear': 'Borrar notas',
  'notes.confirmClear': 'Tocá de nuevo para borrar',
  'notes.saved': 'Guardado',
  'notes.chars': '{count} caracteres',
  ...
  'session.browseFiles': 'Explorar carpeta',
  ...
  'notification.completionTitle': 'OpenHer Completado',
  ...
  'mcpBrowser.noMatch': 'Sin coincidencias',
  'mcp.title': 'MCP',
  ...
  'mcp.connect': 'Activar',
  'mcp.disconnect': 'Desactivar',
  'mcp.working': 'Aplicando…',
  'mcp.refresh': 'Actualizar',
  'mcp.empty': 'No hay servidores MCP configurados',
  'mcp.v2Only': 'La gestión de servidores MCP requiere la API v2 (OpenHer v2)',
  'mcp.loadError': 'No se pudieron cargar los servidores MCP',
  'mcp.actionError': 'No se pudo cambiar el estado',
...
'settings.chatTextWidth': 'Ancho del texto (px de margen por lado)',
  ...
  'image.apply': 'Aplicar',
  'image.close': 'Cerrar',
  'image.expand': 'Ampliar imagen',
  'image.brushColor': 'Color del pincel',
  'image.brushSize': 'Grosor del pincel',
  'sessions.select': 'Seleccionar sesiones',
  'sessions.coupleSubsessions': 'Acoplar subsesiones',
  'sessions.coupleSubsessionsHint': 'Muestra las subsesiones bajo su sesión en Favoritos, cuando la sesión está en la lista',
  ...
  'extras.shutdownHostDesc': 'Envía un comando de apagado a la computadora que ejecuta el servidor OpenHer',
  'extras.shutdownConfirmTitle': '¿Apagar la computadora huesped?',
  'extras.shutdownConfirmBody': 'La computadora que ejecuta el servidor OpenHer se apagará. Esta acción no se puede deshacer.',
...
'extras.restartHostDesc': 'Reinicia la computadora que ejecuta el servidor OpenHer',
'extras.restartConfirmTitle': '¿Reiniciar la computadora huesped?',
'extras.restartConfirmBody': 'La computadora que ejecuta el servidor OpenHer se reiniciará en 10 segundos. Esta acción no se puede deshacer.',
...
'extras.restartFailed': 'Error al enviar el comando de reinicio: {error}',
  ...
  'connect.search': 'Buscar proveedor...',
  'connect.noResults': 'Ningún proveedor coincide con la búsqueda.',
  'connect.connectedCount': 'Conectados: {count}',
  'connect.clearSearch': 'Limpiar búsqueda',
  'connect.addAccount': 'Agregar cuenta',
  'connect.accountDefault': 'default',
  'connect.accountActive': 'Activa',
  'connect.accountActivate': 'Activar',
  'connect.accountRemove': 'Quitar cuenta',
  'connect.accountLabel': 'Nombre de la cuenta (opcional)',
  'connect.accountLabelPlaceholder': 'Cuenta {n}',
  'connect.accountLabelHint': 'Poné un nombre para distinguirla de las otras cuentas de este proveedor.',
  ...
  'learning.menu': 'Menú',
  'learning.lessons': '{count} lecciones',
  'learning.search': 'Buscar lecciones…',
  'learning.noResults': 'Sin resultados para esa búsqueda.',
  'learning.clearSearch': 'Limpiar búsqueda',
  'learning.resume': 'Continuar donde quedé',
  'learning.hideCompleted': 'Ocultar completadas',
  'learning.showCompleted': 'Mostrar completadas',
  'learning.remaining': 'Te quedan ~{count} min',
  'learning.route': 'Ruta de aprendizaje',
  'learning.routeHint': 'Elegí un nodo para continuar esa sección. El orden es el recomendado.',
  'learning.andMore': '…y {count} más',
  'learning.showAll': 'Ver todo',
  'learning.showLess': 'Ver menos',
  'learning.openPending': 'Abrir primera pendiente',
  'learning.markCatDone': 'Marcar sección completa',
  'learning.reset': 'Reiniciar progreso',
  'learning.retry': 'Reintentar',
  'learning.askChat': 'Preguntar al chat',
  'learning.askPrompt': 'Sobre la lección "{lesson}"{section}: ',
  'learning.askSection': ' (sección "{section}")',
  'learning.recent': 'Recientes',
  'learning.searchOpen': 'Buscar',
  'learning.resetConfirm': 'Tocá de nuevo para reiniciar todo',
  'learning.newSection': 'Nueva sección',
  'learning.sectionName': 'Nombre de la sección…',
  'learning.create': 'Crear',
  'learning.addDoc': 'Añadir documento a esta sección',
  'learning.newDoc': 'Crear documento vacío',
  'learning.docName': 'Nombre del documento…',
  'learning.deleteDoc': 'Eliminar documento',
  'learning.deleteSection': 'Eliminar sección',
  'learning.dropHere': 'Soltá archivos acá',
  'learning.emptyCat': 'Vacío — arrastrá lecciones o archivos .md',
  'learning.back': 'Volver',
  'learning.prev': 'Anterior',
  'learning.next': 'Siguiente',
  'learning.markDone': 'Marcar completada',
  'learning.completed': 'Completada',
  'learning.contents': 'Contenido',
  'learning.loading': 'Cargando…',
  'learning.loadingCurriculum': 'Cargando curriculum…',
  'learning.ofLesson': 'Lección {i} de {n}',
  'learning.download': 'Descargar .md',
  'learning.diagramSummary': 'Resumen de la sección',
  'learning.showDiagram': 'Ver diagrama completo',
  'learning.hideDiagram': 'Ocultar diagrama',
  'learning.enlarge': 'Ampliar',
  'learning.close': 'Cerrar',
  'learning.minutes': '{count} min',
  'learning.custom': 'personal',
  'learning.level': 'Nivel',
  ...
  'debate.title': 'Mesa de trabajo',
  'debate.openRoom': 'Abrir mesa de trabajo',
  'debate.chip': 'Mesa · {turns} turnos · consenso {pct}%',
  'debate.close': 'Cerrar',
  'debate.live': 'en curso',
  'debate.finished': 'finalizado',
  'debate.paused': 'en pausa',
  'debate.pause': 'Pausar',
  'debate.resume': 'Reanudar',
  'debate.stop': 'Detener',
  'debate.send': 'Intervenir',
  'debate.intervenePlaceholder': 'Escribí para intervenir en el debate…',
  'debate.noDebate': 'Esta sesión todavía no tiene mesa. Pedile al agente que inicie una.',
  'debate.empty': 'Todavía no hay mensajes en este debate.',
  'debate.typing': 'debatiendo…',
  'debate.consensusLabel': 'Acuerdo',
  'debate.turnsCount': '{count} turnos',
  'debate.stalled': 'estancado',
  'debate.budget': 'presupuesto {pct}%',
  'debate.tokensEst': '{count} tokens est.',
  'debate.elapsed': '{time}',
  'debate.you': 'tú',
  'debate.consensusReady': 'DE ACUERDO',
  'debate.dissenting': 'CON PENDIENTES',
  'debate.confidence': '{pct}% conf.',
  'debate.repliesTo': 'responde a {role}',
  'debate.actaTitle': 'Propuesta acordada',
  'debate.consensusYes': 'con acuerdo',
  'debate.consensusNo': 'sin acuerdo',
  'debate.actaConfidence': 'confianza {pct}%',
  'debate.minorities': 'Riesgos abiertos',
  'debate.timeline': 'Historial',
  'debate.tlStart': 'inicio',
  'debate.tlIntervention': 'intervención',
  'debate.tlActa': 'propuesta final',
  ...
  // B10 (F3): strings de UI de los 8 hooks (useConfig/useAI/useSessions/useShell/
  // useProviderManager/useDevServer/useAppUpdate/useRemoteDesktop).
  'error.unknown': 'Error desconocido',
  'error.connectionTimeout': 'Tiempo de conexión agotado',
  'error.noAgents': 'Sin agentes — reintentando',
  'error.agentListTimeout': 'Tiempo de espera de la lista de agentes',
  'error.noModels': 'Sin modelos - verifica proveedores en OpenHer',
  'error.modelListTimeout': 'Model list timeout - OpenHer lento',
  'error.notProjectFolder': 'La carpeta {directory} no es un proyecto de OpenHer.',
  'error.noDevCommand': 'No hay comando dev configurado',
  'error.noRemoteShell': 'No hay shell remoto disponible para actualizar',
  'error.updateApplyFailed': 'No se pudo aplicar la actualización',
  'error.installerUnavailable': 'Instalador no disponible en este dispositivo',
  'error.streamClosed': 'Transmisión cerrada',
  'error.connectionFailed': 'Conexión fallida',
  'settings.timeoutHint': 'El servidor no respondió en 7s. Probé 4096 y 4098 (OpenHer v2). Verificá que el servidor OpenHer esté corriendo. Para v2 usa 127.0.0.1:4098 usuario opencode pass octavio.',
  'settings.refusedHint': 'Conexión rechazada. Probé 4096 y 4098. Iniciá el servidor con: opencode serve --port 4096  o  opencode2 serve --service (usa 4098/octavio)',
  'settings.nameNotResolvedHint': 'No se pudo resolver el host.',
  'settings.authFailedHint': 'Auth fallida. Para 4098 usa usuario opencode y pass octavio (ver C:\\Users\\...\\.config\\opencode\\service.json)',
  'terminal.shellChanged': '[Terminal] Shell cambiada a: {shell}',
  'terminal.commandSent': ' [{shell}] Comando enviado a {directory}',
  'terminal.sessionFallback': 'sesión',
  'terminal.error': 'Error: {message}',
  'toolpart.inProgress': 'En progreso…',
  'toolpart.completed': 'Completado',
  'toolpart.promptObjective': 'Objetivo / Prompt',
  'toolpart.loadingSubagent': 'Cargando acciones y mensajes del subagente…',
  'detail.noticeServer': 'aviso del servidor',
  'detail.outputServer': 'salida del servidor',
  'detail.toolCatalog': 'catálogo de herramientas',
  'detail.tokensPerSecond': 'Velocidad de generación de tokens',
  'detail.interrupted': 'interrumpido',
  'detail.hideOriginal': 'ocultar original',
  'detail.showOriginal': 'ver original',
  'detail.loadEarlier': '↑ Cargar {count} mensajes anteriores ({remaining} restantes)',
  'detail.editConfirmBody': 'Se revierte la sesión hasta este mensaje y el texto se carga en el compositor.',
  'chat.dragToMove': 'Arrastra para mover',
  'common.copied': '¡Copiado!',
  'session.compacting': 'Compactando sesión…',
}
