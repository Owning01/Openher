...
export default {
  ...
  'error.title': '錯誤',
  'error.close': '關閉',
  'error.transport': '無法連線到伺服器。請確認兩台裝置的 Tailscale 皆已連線、「設定」中的主機與連接埠正確，且 OpenHer 仍在執行。',
  'nav.settings': '設定',
  'nav.sessions': '工作階段',
  'nav.detail': '詳細',
  'nav.help': '說明',
  ...
  'composer.inputLabel': '傳送訊息給 OpenHer',
  ...
  'menu.detailDescription': '與 OpenHer 對話',
  ...
  'settings.connectedSaved': '已連線至 OpenHer {version}。設定已儲存。',
  'settings.draftHint': '變更會自動儲存。測試只檢查下方欄位，不會切換頁面。',
  'settings.testedNotSaved': '連線正常：OpenHer {version}。尚未儲存任何變更。',
  ...
  'settings.defaultModelSearch': '搜尋模型...',
  'settings.defaultModelNoResults': '沒有相符的模型',
  'settings.defaultModelHidden': '(已隱藏)',
  ...
  'desktop.dataToggle': '數據',
  'desktop.dataHide': '隱藏數據',
  'desktop.dataShow': '顯示數據',
  'desktop.settings': '設定',
  'session.remoteDesktop': '遠端桌面',
  'settings.desktopTitle': '遠端桌面',
  'settings.desktopHint': 'PC 上的 OpenHer Desktop Agent（desktop-agent，連接埠 5901）。與伺服器相同的認證。',
  'settings.desktopTest': '測試連線',
  'settings.desktopTestOk': '可連線到桌面代理',
  'settings.desktopTestFail': '無法連線到桌面代理',
  'settings.desktopOk': '已連線到 {os}（v{v}）',
  'settings.desktopFail': '桌面連線失敗：{err}',
  ...
  'settings.questionError': '傳送失敗，請重試。',
  'update.available': '有新版本 {version} 可用',
  'update.downloading': '下載中…',
  'update.installing': '正在開啟安裝程式…',
  'update.install': '更新',
  'update.error': '更新失敗',
  'update.later': '稍後',
...
'settings.featureFlagsDesc': '啟用或停用附加功能',
  ...
  'connection.connecting': '正在連線到 OpenHer...',
  ...
  'connection.offline': '無法連線到 OpenHer',
  'settings.connectionFailed': '連線失敗：{message}',
  'settings.connectedTo': '已連線至 OpenHer v{version}',
  ...
  'sessions.projectDirectoryInvalid': '{directory} 不是 OpenHer 專案資料夾。請選擇專案/worktree 資料夾，或使用伺服器預設。',
...
'sessions.selectOne': '選擇一個工作階段以開始',
  'sessions.loadingTitle': '正在連線到 OpenHer',
  'sessions.loadingHint': '正在載入工作階段。行動裝置或伺服器剛喚醒時可能需要幾秒。',
  'sessions.offlineHint': '尚無法連線到 OpenHer。請檢查設定或重新整理。',
...
'detail.thinking': '思考中…',
  ...
  'toolpart.background': '背景執行',
  'toolpart.backgroundRunning': '背景執行中',
  'toolpart.backgroundHint': '非同步背景執行：你處理其他事情時仍會繼續運作',
  ...
  'help.troubleshooting.content': '<b>連線診斷</b>|1. 確認伺服器：檢查 OpenHer 是否在連接埠 4096 上監聽|2. 本機測試：從同一台機器確認健康端點|3. 網路測試：從手機瀏覽器確認健康端點|4. 檢查防火牆：確保連接埠 4096 已開啟||<b>健康檢查命令</b>|<code>curl -u opencode:your-password http://127.0.0.1:4096/global/health</code>|<code>curl -u opencode:your-password http://YOUR_PC_IP:4096/global/health</code>||<b>常見問題</b>|CORS 錯誤：為伺服器加入 --cors 旗標|連線逾時：檢查防火牆設定|認證失敗：確認使用者名稱/密碼',
  'help.commands.content': '本機行動端命令由應用程式處理。伺服器命令從 OpenHer 載入。',
  ...
  'session.promptHistory': '提示歷史',
  'session.promptHistoryEmpty': '尚無提示',
  'session.promptHistorySearch': '篩選提示...',
  'session.promptHistoryDockLeft': '停靠左側',
  'session.promptHistoryDockRight': '停靠右側',
  'session.promptHistoryFloat': '浮動面板',
  ...
  'notification.completionTitle': 'OpenHer 完成',
  ...
  'mcp.status.needs_auth': '需要驗證',
  'mcp.connect': '啟用',
  'mcp.disconnect': '停用',
  'mcp.working': '套用中…',
  'mcp.refresh': '重新整理',
  'mcp.empty': '尚未設定 MCP 伺服器',
  'mcp.v2Only': 'MCP 伺服器管理需要 API v2（OpenHer）',
  'mcp.loadError': '無法載入 MCP 伺服器',
  'mcp.actionError': '無法變更狀態',
...
'fileEditor.loading': '載入檔案中...',
  ...
  'extras.shutdownHostDesc': '向執行 OpenHer 伺服器的電腦發送關機指令',
  'extras.shutdownConfirmTitle': '關閉主機電腦？',
  'extras.shutdownConfirmBody': '執行 OpenHer 伺服器的電腦將被關閉。此操作無法復原。',
...
'extras.restartHostDesc': '重新啟動執行 OpenHer 伺服器的電腦',
'extras.restartConfirmTitle': '重新啟動主機電腦？',
'extras.restartConfirmBody': '執行 OpenHer 伺服器的電腦將在 10 秒後重新啟動。此操作無法復原。',
