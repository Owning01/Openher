...
export default {
  ...
  'error.title': 'Error',
  'error.close': 'Close',
  'error.transport': 'Could not reach the server. Check that Tailscale is connected on both devices, the host and port in Settings are correct, and OpenHer is still running.',
  ...
  'settings.sb_studio': 'Studio',
  'studio.title': 'Studio',
  'studio.emptyTitle': 'Start a project',
  'studio.emptyHint': 'Generate a new base or open something that already exists. Then select elements and edit them with the agent.',
  'studio.newWithOpenDesign': 'Generate with Open Design',
  'studio.newWithOpenDesignDesc': 'Write the brief in OpenDesign; it generates the artifact. When it finishes, open it here to edit the real code.',
  'studio.newWithOpenDesignHint': 'Design in OpenDesign, then edit the code in Studio',
  'studio.openFolder': 'Open existing project',
  'studio.openFolderDesc': 'Pick a folder and the Studio starts its dev server with hot-reload to inspect and edit.',
  'studio.back': 'Back',
  'studio.refresh': 'Refresh',
  'studio.detected': 'Detected in Open Design',
  'studio.noProjects': 'No projects detected. Generate one in Open Design.',
  'studio.noDirectory': 'No working directory',
  'studio.openInStudio': 'Open in Studio',
  'studio.project': 'Project',
  'studio.closeProject': 'Close project',
  'studio.devRunning': 'dev server · {url}',
  'studio.staticFallback': 'static preview (no dev server)',
  'studio.staticMode': 'static preview',
  'studio.startDev': 'Start dev server',
  'studio.starting': 'Starting…',
  'studio.stopDev': 'Stop dev server',
  'studio.changeFolder': 'Change folder',
  'studio.zones': 'Marked zones',
  'studio.noZones': 'No zones yet. Activate selection and click an element in the canvas.',
  'studio.removeZone': 'Remove zone',
  'studio.openSource': 'Open source',
  'studio.zoneNotePlaceholder': 'What should change here?',
  'studio.entryPoint': 'Entry point',
  'studio.agent': 'Agent',
  'studio.zonesCount': '{count} zones · scoped',
  'studio.creatingSession': 'Preparing the project agent session…',
  'studio.sessionFailed': 'Could not create the project agent session. The folder may not be an OpenHer project.',
  'studio.retry': 'Retry',
  'studio.selectElement': 'Select element (click)',
  'studio.selectArea': 'Mark area (drag)',
  'studio.reload': 'Reload',
  'studio.inspecting': 'Selecting',
  ...
  'composer.placeholder': 'Ask anything, @ to mention, / for actions',
  'composer.dropToAdd': 'Drop to add to Agent',
  'composer.send': 'Send',
  'composer.stop': 'Stop',
  'composer.busy': 'Wait for the previous reply to finish',
  'composer.limitExceeded': 'Character limit exceeded',
  'menu.title': 'Menu',
  ...
  'settings.connectedSaved': 'Connected to OpenHer {version}. Configuration saved.',
  'settings.draftHint': 'Changes are saved automatically. Test checks the fields below without changing page.',
  'settings.testedNotSaved': 'Connection OK: OpenHer {version}. Nothing was saved yet.',
    ...
    'settings.goTitle': 'OpenHer Go usage',
    'settings.goHint': 'Query your OpenHer Go quota (rolling, weekly, monthly) via the public API.',
  ...
  'settings.defaultModelSearch': 'Search models...',
  'settings.defaultModelNoResults': 'No matching models',
  'settings.defaultModelHidden': '(hidden)',
  ...
  'voice.noSpeech': 'I didn’t hear you, try again',
  'voice.busy': 'Dictation was busy, try again',
  'voice.error': 'Couldn’t use the microphone',
  ...
  'desktop.dataToggle': 'Data',
  'desktop.dataHide': 'Hide data',
  'desktop.dataShow': 'Show data',
  'desktop.settings': 'Settings',
  'desktop.openDirError': 'Could not open a session in OpenHer',
  'session.remoteDesktop': 'Remote desktop',
  'settings.desktopTitle': 'Remote desktop',
  'settings.desktopHint': 'OpenHer Desktop Agent on the PC (desktop-agent, port 5901). Same auth as the server.',
  ...
  'settings.desktopOk': 'Connected to {os} (v{v})',
  'settings.desktopFail': 'Desktop connection failed: {err}',
  ...
  'go.rolling': 'Last 5 hours',
  'go.weekly': 'Weekly',
  'go.monthly': 'Monthly',
  'go.resets': 'resets',
  'go.models': '{count} models offered',
  'go.modelLimit': 'cap ${limit} · ${input}/${output} per 1M',
  'go.modelNew': 'new model, no price sheet yet',
  'go.sourceCustom': 'Showing usage for the key set on this PC.',
  'go.sourceAuth': 'Showing usage for the TUI /connect key.',
  'go.changeKey': 'Use another key',
  'go.useTuiKey': 'Back to the TUI key',
  ...
  'settings.questionSkipped': 'Skipped',
  'settings.questionError': "Couldn't send. Try again.",
  'update.available': 'New version {version} available',
  'update.downloading': 'Downloading…',
  'update.installing': 'Opening installer…',
  'update.restarting': 'Restarting OpenHer…',
  'update.install': 'Update',
  'update.error': "Couldn't update the app",
  'update.later': 'Later',
...
'settings.featureFlagsDesc': 'Enable or disable additional features',
  ...
  'connection.connecting': 'Connecting to OpenHer...',
  ...
  'connection.offline': 'OpenHer is not reachable',
  'settings.connectionFailed': 'Connection failed: {message}',
  'settings.connectedTo': 'Connected to OpenHer v{version}',
  ...
  'sessions.coupleSubsessions': 'Couple subsessions',
  'sessions.coupleSubsessionsHint': 'Show each session’s subsessions right under it in Favorites, when that session is listed',
  ...
  'sessions.projectDirectoryInvalid': '{directory} is not an OpenHer project folder. Pick a project/worktree folder, or use the server default.',
  ...
  'chat.activeSubagents': 'Active subagents ({count})',
  'chat.activeSubagentsHint': 'View this session\u2019s active subagent chats',
...
'sessions.selectOne': 'Select a session to start',
  'sessions.loadingTitle': 'Connecting to OpenHer',
  'sessions.loadingHint': 'Loading sessions. This can take a few seconds on mobile or after the server wakes up.',
  'sessions.offlineHint': 'OpenHer is not reachable yet. Check Settings or try Refresh.',
  ...
  'weather.desc': 'Show current temperature in the top bar. One tiny request every 30 minutes.',
  ...
  'shell.deleteCard': 'Delete card',
  'shell.addCard': 'Add card',
  'shell.sendToSession': 'Send to session',
  'shell.promptToSend': 'Prompt to send',
  'shell.pickSession': 'Choose session',
  'shell.searchSessions': 'Search sessions...',
  'shell.send': 'Send',
  'shell.sentTo': 'Sent to {name}',
  'shell.sendFailed': 'Could not send',
  'shell.noSessionsFound': 'No sessions found',
  'shell.needsConfig': 'Configure the server first',
  'shell.moreSessions': '+{n} more — filter to see',
  ...
  'shell.opencode2Server': 'OpenHer server :4098',
  'shell.opencode2Start': 'Start server',
  'shell.opencode2Starting': 'Starting…',
  'shell.opencode2Active': 'Server running :4098',
  'shell.opencode2Fail': 'Not responding, retry',
  'shell.apply': 'Apply',
  'shell.export': 'Export',
...
'detail.thinking': 'Thinking…',
  ...
  'diff.annotateLine': 'Annotate this line',
  'diff.annotateHint': 'Click a line to comment on it and send it to the prompt',
  'diff.notePlaceholder': 'What should change…',
  'diff.addNote': 'Add',
  'diff.removeNote': 'Remove comment',
  'diff.sendNotes': 'Send {count} to prompt',
  'settings.sectionAutomations': 'Automations',
  'settings.automationsDesc': 'Recurring prompts on a session, or shell commands on a terminal that wait until it goes quiet.',
  'settings.automationAdd': 'Add',
  'settings.automationName': 'Name',
  'settings.automationPrompt': 'Prompt',
  'settings.automationCommand': 'Command',
  'settings.automationKindPrompt': 'Prompt',
  'settings.automationKindShell': 'Terminal',
  'settings.automationTarget': 'Target (session id or terminal tab)',
  'settings.automationEmpty': 'No automations yet.',
  'settings.automationEnabled': 'enabled',
  'settings.automationLastRun': 'Last run',
  'settings.automationNever': 'never',
  'settings.automationRunNow': 'Run now',
  'settings.automationRemove': 'Delete',
  'settings.automationStatusOk': 'ok',
  'settings.automationStatusError': 'error',
  'settings.automationStatusRunning': 'running',
  'settings.automationEveryMin': 'every {m} min',
  'settings.automationEveryH': 'every {h} h',
  'settings.sectionRuns': 'Runs (fan-out)',
  'settings.runsDesc': 'Dispatch the same prompt to N agents, each in its own git worktree, then merge or discard with a human gate.',
  'settings.runsEmpty': 'No runs yet.',
  'settings.runGateOpen': 'gate open',
  'settings.runGateClosed': 'gate closed',
  'settings.runCloseGate': 'Close gate',
  'settings.runOpenGate': 'Open gate',
  'settings.runDispatch': 'Dispatch',
  'settings.runMerge': 'Merge',
  'settings.runDiscard': 'Discard',
  'settings.runRemove': 'Delete run',
  'settings.runNew': 'New run',
  'settings.runNewDesc': 'Repo path should be the local clone; each task gets <repo>.worktrees/<name> on branch openher/<name>.',
  'settings.runName': 'Run name',
  'settings.runRepo': 'Repo path',
  'settings.runAgents': 'agents',
  'settings.runPrompt': 'Prompt for every agent',
  'settings.runCreate': 'Create',
  'settings.runFailed': 'failed',
  'settings.runRemoveWt': 'Remove this run? Its {count} worktree(s) will be deleted from disk (their work was already merged or discarded).',
  'settings.runRemoveUnmerged': 'Work not merged yet in {count} task(s): the run is removed from the panel and its worktrees stay on disk under <repo>.worktrees (branch openher/* keeps the work).',
  'settings.runRemoveWtFail': 'Could not delete {count} worktree(s); they remain under <repo>.worktrees.',
  ...
  'toolpart.background': 'Background',
  'toolpart.backgroundRunning': 'In background',
  'toolpart.backgroundHint': 'Runs asynchronously: keeps working while you do other things',
  ...
  'help.server.content': '<b>Starting the OpenHer Server</b>|'
    + 'Start OpenHer server with Basic Authentication enabled:|'
  ...
  'help.troubleshooting.content': '<b>Connection Diagnostics</b>|'
    + '1. Verify Server: Check if OpenHer is listening on port 4096|'
  ...
  'help.commands.content': 'Local mobile commands are handled by the app. Server commands are loaded from OpenHer.',
  ...
  'session.promptHistory': 'Prompt history',
  'session.promptHistoryEmpty': 'No prompts yet',
  'session.promptHistorySearch': 'Filter prompts...',
  'session.promptHistoryDockLeft': 'Dock left',
  'session.promptHistoryDockRight': 'Dock right',
  'session.promptHistoryFloat': 'Float panel',
  'session.archived': 'Archived',
  'session.themeCreator': 'Theme Creator',
  'session.compact': 'Compact',
  'session.exportMd': 'Export .md',
  'session.exportMdPath': 'File path',
  'session.exportMdSave': 'Save',
  'session.files': 'Files',
  'session.opencodeHub': 'OpenHer Hub',
  'session.terminal': 'Terminal',
  'session.notes': 'Scratchpad',
  'notes.title': 'Scratchpad',
  'notes.placeholder': 'Jot quick notes… autosaved in this chat',
  'notes.insert': 'Insert in composer',
  'notes.copy': 'Copy notes',
  'notes.clear': 'Clear notes',
  'notes.confirmClear': 'Tap again to clear',
  'notes.saved': 'Saved',
  ...
  'mcp.connect': 'Enable',
  'mcp.disconnect': 'Disable',
  'mcp.working': 'Applying…',
  'mcp.refresh': 'Refresh',
  'mcp.empty': 'No MCP servers configured',
  'mcp.v2Only': 'MCP server management requires API v2 (OpenHer v2)',
  'mcp.loadError': 'Could not load MCP servers',
  'mcp.actionError': 'Could not change the state',
...
'settings.chatTextWidth': 'Text width (px of margin per side)',
  ...
  'settings.chatReduceMotion': 'Reduce motion (disable animations)',
  ...
  'common.collapse': 'Collapse tools',
  'detail.moreTools': 'more tools',
  ...
  'extras.shutdownHostDesc': 'Sends a shutdown command to the computer running the OpenHer server',
  'extras.shutdownConfirmTitle': 'Shut down host?',
  'extras.shutdownConfirmBody': 'The computer running the OpenHer server will be turned off. This action cannot be undone.',
...
'extras.restartHostDesc': 'Restarts the computer running the OpenHer server',
'extras.restartConfirmTitle': 'Restart host?',
'extras.restartConfirmBody': 'The computer running the OpenHer server will restart in 10 seconds. This action cannot be undone.',
...
'extras.restartFailed': 'Restart command failed: {error}',
  ...
  'connect.search': 'Search provider...',
  'connect.noResults': 'No provider matches the search.',
  'connect.connectedCount': 'Connected: {count}',
  'connect.clearSearch': 'Clear search',
  'connect.addAccount': 'Add account',
  'connect.accountDefault': 'default',
  'connect.accountActive': 'Active',
  'connect.accountActivate': 'Activate',
  'connect.accountRemove': 'Remove account',
  'connect.accountLabel': 'Account name (optional)',
  'connect.accountLabelPlaceholder': 'Account {n}',
  'connect.accountLabelHint': 'Give it a name to tell it apart from your other accounts of this provider.',
  ...
  'learning.menu': 'Menu',
  'learning.lessons': '{count} lessons',
  'learning.search': 'Search lessons…',
  'learning.noResults': 'No results for that search.',
  'learning.clearSearch': 'Clear search',
  'learning.resume': 'Resume where you left off',
  'learning.hideCompleted': 'Hide completed',
  'learning.showCompleted': 'Show completed',
  'learning.remaining': '~{count} min left',
  'learning.route': 'Learning path',
  'learning.routeHint': 'Pick a node to continue that section. Order is recommended.',
  'learning.andMore': '…and {count} more',
  'learning.showAll': 'Show all',
  'learning.showLess': 'Show less',
  'learning.openPending': 'Open first pending',
  'learning.markCatDone': 'Mark section complete',
  'learning.reset': 'Reset progress',
  'learning.retry': 'Retry',
  'learning.askChat': 'Ask chat',
  'learning.askPrompt': 'About the lesson "{lesson}"{section}: ',
  'learning.askSection': ' (section "{section}")',
  'learning.recent': 'Recent',
  'learning.searchOpen': 'Search',
  'learning.resetConfirm': 'Tap again to reset everything',
  'learning.newSection': 'New section',
  'learning.sectionName': 'Section name…',
  'learning.create': 'Create',
  'learning.addDoc': 'Add document to this section',
  'learning.newDoc': 'Create empty document',
  'learning.docName': 'Document name…',
  'learning.deleteDoc': 'Delete document',
  'learning.deleteSection': 'Delete section',
  'learning.dropHere': 'Drop files here',
  'learning.emptyCat': 'Empty — drag lessons or .md files',
  'learning.back': 'Back',
  'learning.prev': 'Previous',
  'learning.next': 'Next',
  'learning.markDone': 'Mark complete',
  'learning.completed': 'Completed',
  'learning.contents': 'Contents',
  'learning.loading': 'Loading…',
  'learning.loadingCurriculum': 'Loading curriculum…',
  'learning.ofLesson': 'Lesson {i} of {n}',
  'learning.download': 'Download .md',
  'learning.diagramSummary': 'Section summary',
  'learning.showDiagram': 'View full diagram',
  'learning.hideDiagram': 'Hide diagram',
  'learning.enlarge': 'Enlarge',
  ...
  'scm.noStaged': 'Nothing staged',
  'scm.noUpstream': 'No upstream',
  ...
  'debate.title': 'Work table',
  'debate.openRoom': 'Open work table',
  'debate.chip': 'Table · {turns} turns · agreement {pct}%',
  'debate.close': 'Close',
  'debate.live': 'live',
  'debate.finished': 'finished',
  'debate.paused': 'paused',
  'debate.pause': 'Pause',
  'debate.resume': 'Resume',
  'debate.stop': 'Stop',
  'debate.send': 'Intervene',
  'debate.intervenePlaceholder': 'Write to intervene in the debate…',
  'debate.noDebate': 'This session has no table yet. Ask the agent to start one.',
  'debate.empty': 'No messages in this debate yet.',
  'debate.typing': 'debating…',
  'debate.consensusLabel': 'Agreement',
  'debate.turnsCount': '{count} turns',
  'debate.stalled': 'stalled',
  'debate.budget': 'budget {pct}%',
  'debate.tokensEst': '{count} tok. est.',
  'debate.elapsed': '{time}',
  'debate.you': 'you',
  'debate.consensusReady': 'AGREED',
  'debate.dissenting': 'OPEN ISSUES',
  'debate.confidence': '{pct}% conf.',
  'debate.repliesTo': 'replies to {role}',
  'debate.actaTitle': 'Agreed proposal',
  'debate.consensusYes': 'agreed',
  'debate.consensusNo': 'no agreement',
  'debate.actaConfidence': 'confidence {pct}%',
  'debate.minorities': 'Open risks',
  'debate.timeline': 'Timeline',
  'debate.tlStart': 'start',
  'debate.tlIntervention': 'intervention',
  'debate.tlActa': 'final proposal',
  'debate.tlDone': 'end: {reason}',
  ...
  'error.noAgents': 'No agents — retrying',
  'error.agentListTimeout': 'Agent list timeout',
  'error.noModels': 'No models — check providers in OpenHer',
  'error.modelListTimeout': 'Model list timeout - OpenHer slow',
  'error.notProjectFolder': '{directory} is not an OpenHer project folder.',
  'error.noDevCommand': 'No dev command configured',
  'error.noRemoteShell': 'No remote shell available to update',
  'error.updateApplyFailed': 'Could not apply the update',
  'error.installerUnavailable': 'Installer not available on this device',
  'error.streamClosed': 'Stream closed',
  'error.connectionFailed': 'Connection failed',
  'settings.timeoutHint': 'The server did not respond within 7s. I tried 4096 and 4098 (OpenHer v2). Check that the OpenHer server is running. For v2 use 127.0.0.1:4098, user opencode, pass octavio.',
  'settings.refusedHint': 'Connection refused. I tried 4096 and 4098. Start the server with: opencode serve --port 4096  or  opencode2 serve --service (uses 4098/octavio)',
  'settings.nameNotResolvedHint': 'Could not resolve the host.',
  'settings.authFailedHint': 'Authentication failed. For 4098 use user opencode and pass octavio (see C:\\Users\\...\\.config\\opencode\\service.json)',
  'terminal.shellChanged': '[Terminal] Shell changed to: {shell}',
  'terminal.commandSent': ' [{shell}] Command sent to {directory}',
  'terminal.sessionFallback': 'session',
