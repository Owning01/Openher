...
export default {
  ...
  'error.title': 'Error',
  'error.close': 'Close',
  'error.transport': 'Could not reach the server. Check that Tailscale is connected on both devices, the host and port in Settings are correct, and opencode is still running.',
...
'sessions.selectOne': 'Select a session to start',
  ...
  'shell.opencode2Server': 'opencode2 server :4098',
