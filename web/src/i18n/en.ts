...
'extras.restartFailed': 'Restart command failed: {error}',
  ...
  'debate.title': 'Debate',
  'debate.openRoom': 'Open debate room',
  'debate.chip': 'Debate · {turns} turns · consensus {pct}%',
  'debate.close': 'Close',
  'debate.live': 'live',
  ...
  'debate.noDebate': 'This session has no debate yet. Ask the agent to start one.',
  'debate.empty': 'No messages in this debate yet.',
  'debate.typing': 'debating…',
  'debate.consensusLabel': 'Consensus',
  ...
  'debate.elapsed': '{time}',
  'debate.you': 'you',
  'debate.consensusReady': 'CONSENSUS',
  'debate.dissenting': 'DISSENTING',
  'debate.confidence': '{pct}% conf.',
  'debate.repliesTo': 'replies to {role}',
  'debate.actaTitle': 'Minutes — arbiter',
  'debate.consensusYes': 'with consensus',
  'debate.consensusNo': 'without consensus',
  'debate.actaConfidence': 'confidence {pct}%',
  'debate.minorities': 'Minorities',
  'debate.timeline': 'Timeline',
  'debate.tlStart': 'start',
  'debate.tlIntervention': 'intervention',
  'debate.tlActa': 'arbiter minutes',
