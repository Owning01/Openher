...
type TranslationKey =
  ...
  | 'sessions.creating'
  | 'sessions.refresh'
  | 'sessions.coupleSubsessions'
  | 'sessions.coupleSubsessionsHint'
  ...
  | 'shell.promptToSend'
  | 'shell.pickSession'
  | 'shell.searchSessions'
  | 'shell.send'
  | 'shell.sentTo'
  | 'shell.sendFailed'
  | 'shell.noSessionsFound'
  | 'shell.needsConfig'
  | 'shell.moreSessions'
  | 'shell.searchDocs'
  | 'shell.officialDocs'
  ...
  | 'shell.launch'
  | 'shell.autostart'
  | 'shell.opencode2Server'
  | 'shell.opencode2Start'
  | 'shell.opencode2Starting'
  | 'shell.opencode2Active'
  | 'shell.opencode2Fail'
  | 'shell.apply'
  | 'shell.export'
  | 'shell.copied'
...
| 'shell.kindLabs'
  ...
  | 'diff.annotateLine'
  | 'diff.annotateHint'
  | 'diff.notePlaceholder'
  | 'diff.addNote'
  | 'diff.removeNote'
  | 'diff.sendNotes'
  | 'settings.sectionAutomations'
  | 'settings.automationsDesc'
  | 'settings.automationAdd'
  | 'settings.automationName'
  | 'settings.automationPrompt'
  | 'settings.automationCommand'
  | 'settings.automationKindPrompt'
  | 'settings.automationKindShell'
  | 'settings.automationTarget'
  | 'settings.automationEmpty'
  | 'settings.automationEnabled'
  | 'settings.automationLastRun'
  | 'settings.automationNever'
  | 'settings.automationRunNow'
  | 'settings.automationRemove'
  | 'settings.automationStatusOk'
  | 'settings.automationStatusError'
  | 'settings.automationStatusRunning'
  | 'settings.automationEveryMin'
  | 'settings.automationEveryH'
  | 'settings.sectionRuns'
  | 'settings.runsDesc'
  | 'settings.runsEmpty'
  | 'settings.runGateOpen'
  | 'settings.runGateClosed'
  | 'settings.runCloseGate'
  | 'settings.runOpenGate'
  | 'settings.runDispatch'
  | 'settings.runMerge'
  | 'settings.runDiscard'
  | 'settings.runRemove'
  | 'settings.runNew'
  ...
  | 'settings.runCreate'
  | 'settings.runFailed'
  | 'settings.runRemoveWt'
  | 'settings.runRemoveUnmerged'
  | 'settings.runRemoveWtFail'
  | 'toolpart.wrote'
  | 'toolpart.edited'
  | 'toolpart.patched'
  | 'toolpart.subagent'
  ...
  | 'toolpart.background'
  | 'toolpart.backgroundRunning'
  | 'toolpart.backgroundHint'
  | 'session.deleteTitle'
...
| 'voice.error'
  ...
  | 'settings.defaultModelSearch'
  | 'settings.defaultModelNoResults'
  | 'settings.defaultModelHidden'
  ...
  | 'connect.clearSearch'
  | 'connect.addAccount'
  | 'connect.accountDefault'
  | 'connect.accountActive'
  | 'connect.accountActivate'
  | 'connect.accountRemove'
  | 'connect.accountLabel'
  | 'connect.accountLabelPlaceholder'
  | 'connect.accountLabelHint'
  | 'connect.noProviders'
  ...
  | 'learning.search'
  | 'learning.noResults'
  | 'learning.clearSearch'
  | 'learning.resume'
  | 'learning.hideCompleted'
  | 'learning.showCompleted'
  | 'learning.remaining'
  | 'learning.route'
  | 'learning.routeHint'
  | 'learning.andMore'
  | 'learning.showAll'
  | 'learning.showLess'
  | 'learning.openPending'
  | 'learning.markCatDone'
  | 'learning.reset'
  | 'learning.retry'
  | 'learning.askChat'
  | 'learning.askPrompt'
  ...
  | 'learning.contents'
  | 'learning.loading'
  | 'learning.loadingCurriculum'
  | 'learning.ofLesson'
  | 'learning.download'
  | 'learning.diagramSummary'
  | 'learning.showDiagram'
  | 'learning.hideDiagram'
  | 'learning.enlarge'
  | 'learning.close'
  | 'learning.minutes'
  | 'learning.custom'
  ...
  | 'studio.emptyTitle'
  | 'studio.emptyHint'
  | 'studio.newWithOpenDesign'
  | 'studio.newWithOpenDesignDesc'
  | 'studio.newWithOpenDesignHint'
  | 'studio.openFolder'
  | 'studio.openFolderDesc'
  | 'studio.back'
  | 'studio.refresh'
  | 'studio.detected'
  | 'studio.noProjects'
  ...
  | 'studio.removeZone'
  | 'studio.openSource'
  | 'studio.zoneNotePlaceholder'
  | 'studio.entryPoint'
  | 'studio.agent'
  | 'studio.zonesCount'
  | 'studio.creatingSession'
  | 'studio.sessionFailed'
  | 'studio.retry'
